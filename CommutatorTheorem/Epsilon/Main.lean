...
/-!
# Main Theorems: Fillmore's Lemma and the Quantitative Commutator Theorem

This file formalizes the main results of JOS 2013:
- Fillmore's lemma: every trace-zero matrix is unitarily equivalent to a zero-diagonal matrix
